...
const BASE_URL_CODES =
  "https://v6.exchangerate-api.com/v6/eb1f59571b8e084790d86afe/codes";
const BASE_URL =
  "https://v6.exchangerate-api.com/v6/eb1f59571b8e084790d86afe/latest/EUR";
const CUSTOM_URL =
  "https://v6.exchangerate-api.com/v6/eb1f59571b8e084790d86afe/latest/";
...
function App() {
  ...
  useEffect(() => {
    if (fromCurrency != null && toCurrency != null) {
      fetch(
        `https://v6.exchangerate-api.com/v6/eb1f59571b8e084790d86afe/latest/${fromCurrency}`
      )
        .then((res) => res.json())
        .then((data) => {
          const firstCurrency = Object.keys(data.conversion_rates)[47];
  ...
  return (
    ...
    <>
      ...
      <CurrencyRow
        ...
        onchangeCurrency={(e) =>
          setFromCurrency(e.target.value, console.log(e.target.value))
        }
